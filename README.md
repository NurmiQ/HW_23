...
| Выполнение запроса | Вывод |
| --- | --- |
| query=limit:3 | 1.181.2.178 [17/May/2015:20:05:36] "GET / HTTP/1.1" 200
1.125.2.148 [17/May/2015:20:05:19] "GET /?flav=rss20 HTTP/1.1" 200
1.170.2.204 [17/May/2015:20:05:03] "POST /?flav=atom HTTP/1.1" 200 |
...
- [ ]  Решение позволяет конструировать запрос, то есть можно составлять конструкции вида query=filter:GET|map:0|unique|sort:desc.
